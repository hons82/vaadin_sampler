...
@PageTitle("AutosuggestOrig")
@Route(value = "autosuggestOrig", layout = MainLayout.class)
public class AutosuggestOrigView extends Composite<VerticalLayout> {
	...
	protected VerticalLayout initContent() {
		...
		FlexLayout first = new FlexLayout();
		first.setJustifyContentMode(FlexComponent.JustifyContentMode.EVENLY);
...
//		});
		...
		var layout = new VerticalLayout(first, second);
		layout.setSizeFull();
		return layout;
	}
